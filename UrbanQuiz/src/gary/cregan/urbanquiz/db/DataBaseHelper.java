...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_NAME = "UrbanDictionaryQuizDB";
	...
	public String getWord(int id)
	{
		...
		Cursor c = myDataBase.query("DICTIONARY", new String[]{"WORD"}, "_id=?", new String[]{Integer.toString(id)}, null, null, null);
		if(c != null)
		{
			c.moveToFirst();
			returnedValue = c.getString(c.getColumnIndex("WORD"));
		}
		c.close();
